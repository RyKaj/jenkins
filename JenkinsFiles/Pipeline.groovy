		...
		stage ("Source Control") {
			...
			steps {
				// parallel (
					...
					// 	script {
					// 		echo "SonarQube Setup...";
					// 		temp = "${env.JENKINS_HOME}\\buildContent\\${osPlatform}\\";
					// 		if ( fileExists( temp ) ) {
					// 			dir(temp) {
					// 				stash includes: 'build.xml', 
					// 				name: 'ant-sonar'
					...
					// 		}
					// 		else {
					// 			echo console.Error("Jenkins server does not have SonarQube configured correctly");
					// 		}
					// 	}
